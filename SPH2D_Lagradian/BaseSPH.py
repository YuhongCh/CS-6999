...
class BaseSPH:
    ...
    def compute_density(self):
        for pid in range(self.num_particle):
            if self.particle_system.type[pid] == ParticleType.Fluid:
                ...
                self.particle_system.density[pid] = ti.max(density, self.particle_system.ref_density)
            else:
                self.particle_system.density[pid] = self.particle_system.ref_density
    ...
    def reset_parameters(self):
        self.d_velocity.fill(tm.vec2(0, 0))
